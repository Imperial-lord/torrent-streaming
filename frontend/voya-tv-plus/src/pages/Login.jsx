    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-32 left-16 w-3 h-3 bg-white/10 rounded-full animate-bounce"
                     style={{ animationDelay: '2s' }} />
                <div className="absolute top-60 right-20 w-1.5 h-1.5 bg-accent/30 rounded-full animate-pulse"
                    ...
                    >
                        <div className="backdrop-blur-2xl bg-white/[0.05] border border-white/10 rounded-3xl p-8 shadow-2xl hover:bg-white/[0.08] transition-all duration-500">
                            ...
                            <div className="mt-6 text-center text-xs text-white/50 leading-relaxed">
                                ...
                                <button onClick={(e)=>e.preventDefault()} className="text-white/70 hover:text-white underline underline-offset-2 transition-colors duration-200">
                                    Terms of Service
                                </button>{' '}
                                and{' '}
                                <button onClick={(e)=>e.preventDefault()} className="text-white/70 hover:text-white underline underline-offset-2 transition-colors duration-200">
