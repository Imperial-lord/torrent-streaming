    ...
    <div className="relative mx-auto max-w-6xl px-4 mt-6">
      <div className="relative h-[46vw] max-h-[520px] min-h-[280px] rounded-3xl overflow-hidden ring-1 ring-ink-800">
        ...
        <div className="absolute bottom-6 left-6 right-6">
          <h1 className="font-display text-3xl md:text-5xl text-white font-semibold drop-shadow">{title}</h1>
          {plot && (
            <p className="mt-2 text-sm md:text-base text-white/70 line-clamp-3 max-w-2xl">
              {plot}
            </p>
          )}
